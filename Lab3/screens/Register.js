...
const Register = ({ navigation }) => {
  ...
  const handleCreateAccount = async () => {
    try {
      ...
      Alert.alert("Tài khoản đã tồn tại hoặc có lỗi!");
    }
  };
  return (
    <View style={{ flex: 1, padding: 10 }}>
      ...
      <TextInput label={"Address"} value={address} onChangeText={setAddress} style={{ marginBottom: 20 }} />
      <TextInput label={"Phone"} value={phone} onChangeText={setPhone} style={{ marginBottom: 20 }} />
